...
update_keyword(pwscf.control.io , "disk_io" , 'medium')
...
update_keyword( pwscf.kpoints, 'type' ,'crystal') 
update_keyword( pwscf.kpoints, "mesh", [36,36,36,1] )
 
update_keyword( pwscf.system.ecut, "ecutwfc", 35.0)
update_keyword( pwscf.system.ecut, "ecutrho", 4*35)
